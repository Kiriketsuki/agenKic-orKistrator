...
This project is indexed by GitNexus as **agenKic-orKistrator** (656 symbols, 1340 relationships, 29 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
