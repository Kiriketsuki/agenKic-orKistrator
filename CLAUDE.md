...
This project is indexed by GitNexus as **agenKic-orKistrator** (730 symbols, 1613 relationships, 33 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
