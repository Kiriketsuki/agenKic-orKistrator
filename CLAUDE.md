...
This project is indexed by GitNexus as **agenKic-orKistrator** (703 symbols, 2518 relationships, 48 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
